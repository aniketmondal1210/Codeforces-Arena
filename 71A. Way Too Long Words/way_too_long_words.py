# By aniketmondal1210, contest: Codeforces Beta Round 65 (Div. 2), problem: (A) Way Too Long Words, Accepted, #, Copy
t = int(input())
for i in range(t):
    a = input()
    if len(a) > 10:
...
Checker Log
ok 3 words
Test: #4, time: 61 ms., memory: 8 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
1
...
Checker Log
ok 26 words
Test: #8, time: 62 ms., memory: 0 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
1
...
Checker Log
ok a98j
Test: #9, time: 61 ms., memory: 0 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
10
gyartjdxxlcl
fzsck
...
Checker Log
ok 20 words
Test: #11, time: 61 ms., memory: 8 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
50
...
Checker Log
ok 50 words
Test: #12, time: 62 ms., memory: 0 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
100
...
Checker Log
ok 100 words
Test: #15, time: 31 ms., memory: 0 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
100
...
Checker Log
ok 100 words
Test: #17, time: 31 ms., memory: 12 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
100
krntmzhsruy
ftalxlmuc
...
Checker Log
ok 100 words
Test: #18, time: 61 ms., memory: 0 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
100
...
Checker Log
ok 100 words
Test: #19, time: 62 ms., memory: 0 KB, exit code: 0, checker exit code: 0, verdict: OK
Input
100
